 ...
 * http://sourcesup.cru.fr/projects/cookingapp
 */
package org.esupportail.cookingapp.web.controllers;

import org.esupportail.cookingapp.domain.beans.User;
...
public abstract class AbstractContextAwareController extends AbstractDomainAwareBean {
	...
	/**
	 * @see org.esupportail.cookingapp.web.controllers.AbstractDomainAwareBean#afterPropertiesSetInternal()
	 */
	@Override
	...
	/**
	 * @see org.esupportail.cookingapp.web.controllers.AbstractDomainAwareBean#getCurrentUser()
	 */
	@Override
